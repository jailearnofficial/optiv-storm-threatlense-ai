...
export function createApp() {
  ...
  const handleReportRequest = (req: Request, res: Response) => {
    ...
    const analysisRecord = db.getAnalysis(rawId) || db.getAnalysisByLookupId(rawId);
    if (!analysisRecord) {
  ...
  app.get('/api/iocs/:analysis_id', (req: Request, res: Response) => {
    ...
    const analysisRecord = db.getAnalysis(req.params.analysis_id) || db.getAnalysisByLookupId(req.params.analysis_id);
    if (!analysisRecord) {
