        ...
        <div className="w-full max-w-md bg-slate-900/90 border border-slate-800/90 rounded-2xl shadow-2xl p-6 sm:p-8 backdrop-blur-xl relative overflow-hidden">
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <h3 className="font-bold text-amber-300 text-sm">
                    Domain Whitelist Required in Firebase
                  </h3>
                  <p className="text-[11px] text-amber-200/80 mt-1 leading-relaxed">
                    This app domain must be added to your Firebase project&apos;s Authorized Domains list to complete Google Sign-In.
                  </p>
                </div>
              </div>
          ...
          <div className="pt-5 mt-5 border-t border-slate-800 space-y-2">
            <div className="flex items-center gap-2.5 text-xs text-slate-400">
              ...
              <span>Google Identity & Workspace Authentication</span>
            </div>
            <div className="flex items-center gap-2.5 text-xs text-slate-400">
            ...
            <div className="flex items-center gap-2.5 text-xs text-slate-400">
              ...
              <span>Automated SOC Analyst Profile Provisioning</span>
            </div>
          </div>
          ...
          <div className="mt-5 pt-4 border-t border-slate-800/80 text-center">
            <p className="text-[10px] font-mono text-slate-500 leading-relaxed">
              RESTRICTED ENTERPRISE APPLICATION. Unauthorized access is strictly prohibited and subject to legal prosecution.
            </p>
          </div>
        </div>
      </main>
